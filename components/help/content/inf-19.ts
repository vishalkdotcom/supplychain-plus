...
export const inf19: InfoGraphicData = {
  ...
  domain: "Operations",
  shortDescription:
    "The 8-job ML pipeline computes all intelligence in SupplyChain+ \u2014 from risk scores to forecasts \u2014 with strict ordering, GPU serialization, and flexible scheduling.",
  sections: [
    {
      type: "hero",
