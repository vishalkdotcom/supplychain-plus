...
\restrict YhVOB5NXe8yqEgnwY9Hl0X2BHRegnvOfMwN8KzoGI1ef2HUHD0EalTiva9Cw9Jq
...
ALTER FUNCTION public.prevent_duplicate_insert_of_active_employee_id() OWNER TO postgres;
...
ALTER FUNCTION public.prevent_reactivation_and_update_counter() OWNER TO postgres;
...
ALTER FUNCTION public.update_inactive_counter() OWNER TO postgres;
...
ALTER TABLE public.employee_ids OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_client_custom_field_values_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_client_custom_fields_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_participant_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_participant_image_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_participants_phone_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_attachment_task_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_contact_attachment_content_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_contact_attachments_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_contact_group_translations_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_contact_groups_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_contact_groups_translations_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_participant_contact_group_relation_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_participant_counter_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.mdl_wc_participant_custom_field_relation_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.translations_mdlsupportedlanguages_fonts_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.translations_mdlsupportedlanguages_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.translations_mdltranslationconfig_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.translations_mdltranslations_id_seq OWNER TO postgres;
...
\unrestrict YhVOB5NXe8yqEgnwY9Hl0X2BHRegnvOfMwN8KzoGI1ef2HUHD0EalTiva9Cw9Jq
