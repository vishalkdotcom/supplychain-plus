      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Configure API keys and preferred models for SupplyChain+ intelligent
            features.
          </p>
        </div>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  from your browser. SupplyChain+ AI features will not work until
      ...
      <Card>
        <CardHeader className="pb-3 border-b">
          ...
          <CardDescription>
            ...
            active to power SupplyChain+ features.
          </CardDescription>
        </CardHeader>
